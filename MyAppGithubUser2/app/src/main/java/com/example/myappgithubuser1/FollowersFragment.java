...
public class FollowersFragment extends Fragment {
    ...
    private ArrayList<GithubUser> listFollowers = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imgNotFound = view.findViewById(R.id.imgNotFoundFollowers);
        txtNotFound = view.findViewById(R.id.txtNotFoundFollowers);

        imgNotFound.setVisibility(View.INVISIBLE);
        txtNotFound.setVisibility(View.INVISIBLE);
        rvFollowers = view.findViewById(R.id.rv_listFollowers);
    ...
    private void showRecyclerList() {
        ...
        GithubUserAdapter listGithubAdapter = new GithubUserAdapter(listFollowers);
        rvFollowers.setAdapter(listGithubAdapter);
